...
```{r}
#Matrix of scatter plots for new_df independent variables without scaling
new_df$Speed_Category <- as.numeric(new_df$Speed_Category)
scatter_plot = subset (new_df, select = c(-ID_test, -avg_VCO2, -avg_VE, -Weight_ind_VO2, -Athletic)) %>% 
...
matrix = cor(subset (new_df, select = c(-ID_test, -avg_VCO2, -avg_VE, -Weight_ind_VO2, -Athletic, -Sex)), use="complete.obs")
