...
age_density = age_density + scale_x_continuous(breaks=seq(0, 80, 5)) + theme_bw()
age_density
...
plots = grid.arrange(speed_box + theme_bw(), HR_box + theme_bw(), VO2_box + theme_bw(), VCO2_box + theme_bw(), RR_box + theme_bw(), VE_box + theme_bw(), nrow = 2, ncol=3,
...
ggplot(data = melted_gamb, aes(x = Var1, y = Var2, fill = value)) +
  geom_tile() +
  scale_fill_gradient2(midpoint = 0.5, mid ="ivory1", 
                       limits = c(-1, +1)) +
  labs(title = "Correlation Matrix \n On Treadmill Maximal Exercise Data \n", 
